            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="hero-banner__content">
                        ...
                        <p class="hero-banner__text wow fadeInUp" data-wow-delay="500ms">
                            ...
                            <img src="{{ asset('client/images/shapes/banner-1-shape-1.png')}}" alt="eduact">
                        </p>
                ...
                <div class="col-lg-6">
                    <div class="hero-banner__thumb wow fadeInUp" data-wow-delay="700ms">
                        <img src="{{ asset('client/images/resources/banner-1-1.png')}}" alt="eduact">
                        <div class="hero-banner__cap wow slideInDown" data-wow-delay="800ms"><img src="{{ asset('client/images/shapes/banner-cap.png')}}" alt="eduact"></div><!-- banner-cap -->
                        <div class="hero-banner__star wow slideInDown" data-wow-delay="850ms"><img src="{{ asset('client/images/shapes/banner-star.png')}}" alt="eduact"></div><!-- banner-star -->
                        <div class="hero-banner__map wow slideInDown" data-wow-delay="900ms"><img src="{{ asset('client/images/shapes/banner-map.png')}}" alt="eduact"></div><!-- banner-map -->
                        ...
                        <div class="hero-banner__book wow slideInUp" data-wow-delay="1000ms"><img src="{{ asset('client/images/shapes/banner-book.png')}}" alt="eduact"></div><!-- banner-book -->
                        <div class="hero-banner__star2 wow slideInUp" data-wow-delay="1050ms"><img src="{{ asset('client/images/shapes/banner-star2.png')}}" alt="eduact"></div><!-- banner-star -->
                        <div class="hero-banner__cart wow slideInUp" data-wow-delay="1100ms">
                            <div class="hero-banner__cart__thumb"><img src="{{ asset('client/images/resources/banner-author.png')}}" alt="eduact"></div>
                ...
                <div class="col-xl-6">
                    <div class="about-one__thumb wow fadeInLeft" data-wow-delay="100ms"><!-- about thumb start -->
                        <div class="about-one__thumb__one eduact-tilt" data-tilt-options='{ "glare": false, "maxGlare": 0, "maxTilt": 2, "speed": 700, "scale": 1 }'>
                            <img src="{{ asset('client/images/resources/about-1-1.png')}}" alt="eduact">
                        </div>
                        <div class="about-one__thumb__shape1 wow zoomIn" data-wow-delay="300ms">
                            <img src="{{ asset('client/images/shapes/about-shape-1-1.png')}}" alt="eduact">
                        </div>
                        <div class="about-one__thumb__shape2 wow zoomIn" data-wow-delay="400ms">
                            <img src="{{ asset('client/images/shapes/about-shape-1-2.png')}}" alt="eduact">
                        </div>
        ...
        "responsive":{
            ...
            "1400":{
                ...
                <div class="item">
                    <div class="category-one__item">
                        <div class="category-one__wrapper" style="background-image: url(assets/images/shapes/category-shape.png);">
                            <div class="category-one__thumb"><img src="{{ asset('client/images/category/category-normal-1.png')}}" alt="eduact" /></div><!-- /.category-thumb -->
                        ...
                        <div class="category-one__hover">
                            <div class="category-one__hover__thumb">
                                <img src="{{ asset('client/images/category/category-hover-1.png')}}" alt="eduact" />
                            </div><!-- /.category-thumb -->
                ...
                <div class="item">
                    <div class="category-one__item">
                        <div class="category-one__wrapper" style="background-image: url(assets/images/shapes/category-shape.png);">
                            <div class="category-one__thumb"><img src="{{ asset('client/images/category/category-normal-2.png')}}" alt="eduact" /></div><!-- /.category-thumb -->
                            <div class="category-one__content">
                                <div class="category-one__icon">
                        ...
                        <div class="category-one__hover">
                            <div class="category-one__hover__thumb">
                                <img src="{{ asset('client/images/category/category-hover-2.png')}}" alt="eduact" />
                            </div><!-- /.category-thumb -->
                            <div class="category-one__hover__content">
                                <div class="category-one__hover__icon">
                                    <span class="icon-Technology"></span>
                ...
                <div class="item">
                    <div class="category-one__item">
                        <div class="category-one__wrapper" style="background-image: url(assets/images/shapes/category-shape.png);">
                            <div class="category-one__thumb"><img src="{{ asset('client/images/category/category-normal-3.png')}}" alt="eduact" /></div><!-- /.category-thumb -->
                            <div class="category-one__content">
                                <div class="category-one__icon">
                        ...
                        <div class="category-one__hover">
                            <div class="category-one__hover__thumb">
                                <img src="{{ asset('client/images/category/category-hover-3.png')}}" alt="eduact" />
                            </div><!-- /.category-thumb -->
                            <div class="category-one__hover__content">
                                <div class="category-one__hover__icon">
                                    <span class="icon-Digital-marketing"></span>
                ...
                <div class="item">
                    <div class="category-one__item">
                        <div class="category-one__wrapper" style="background-image: url(assets/images/shapes/category-shape.png);">
                            <div class="category-one__thumb"><img src="{{ asset('client/images/category/category-normal-4.png')}}" alt="eduact" /></div><!-- /.category-thumb -->
                            <div class="category-one__content">
                                <div class="category-one__icon">
                        ...
                        <div class="category-one__hover">
                            <div class="category-one__hover__thumb">
                                <img src="{{ asset('client/images/category/category-hover-4.png')}}" alt="eduact" />
                            </div><!-- /.category-thumb -->
                            <div class="category-one__hover__content">
                                <div class="category-one__hover__icon">
                                    <span class="icon-Start-up"></span>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-6 wow fadeInUp" data-wow-delay="100ms">
                    <div class="course-one__item">
                        <div class="course-one__thumb">
                            <img src="{{ asset('client/images/course/course-1-1.png')}}" alt="eduact">
                        ...
                        <div class="course-one__content">
                            ...
                            <div class="course-one__bottom">
                                <div class="course-one__author">
                                    <img src="{{ asset('client/images/course/author-1.png')}}" alt="eduact">
                ...
                <div class="col-xl-4 col-lg-6 wow fadeInUp" data-wow-delay="200ms">
                    <div class="course-one__item">
                        <div class="course-one__thumb">
                            <img src="{{ asset('client/images/course/course-1-2.png')}}" alt="eduact">
                            <a class="course-one__like" href="javascript:void(0);"><span class="icon-like"></span></a>
                        </div><!-- /.course-thumb -->
                        <div class="course-one__content">
                            ...
                            <div class="course-one__bottom">
                                <div class="course-one__author">
                                    <img src="{{ asset('client/images/course/author-2.png')}}" alt="eduact">
                ...
                <div class="col-xl-4 col-lg-6 wow fadeInUp" data-wow-delay="300ms">
                    <div class="course-one__item">
                        <div class="course-one__thumb">
                            <img src="{{ asset('client/images/course/course-1-3.png')}}" alt="eduact">
                            <a class="course-one__like" href="javascript:void(0);"><span class="icon-like"></span></a>
                        </div><!-- /.course-thumb -->
                        <div class="course-one__content">
                            ...
                            <div class="course-one__bottom">
                                <div class="course-one__author">
                                    <img src="{{ asset('client/images/course/author-3.png')}}" alt="eduact">
                ...
                <div class="col-xl-4 col-lg-6 wow fadeInUp" data-wow-delay="400ms">
                    <div class="course-one__item">
                        <div class="course-one__thumb">
                            <img src="{{ asset('client/images/course/course-1-4.png')}}" alt="eduact">
                            <a class="course-one__like" href="javascript:void(0);"><span class="icon-like"></span></a>
                        </div><!-- /.course-thumb -->
                        <div class="course-one__content">
                            ...
                            <div class="course-one__bottom">
                                <div class="course-one__author">
                                    <img src="{{ asset('client/images/course/author-4.png')}}" alt="eduact">
                ...
                <div class="col-xl-4 col-lg-6 wow fadeInUp" data-wow-delay="500ms">
                    <div class="course-one__item">
                        <div class="course-one__thumb">
                            <img src="{{ asset('client/images/course/course-1-5.png')}}" alt="eduact">
                            <a class="course-one__like" href="javascript:void(0);"><span class="icon-like"></span></a>
                        </div><!-- /.course-thumb -->
                        <div class="course-one__content">
                            ...
                            <div class="course-one__bottom">
                                <div class="course-one__author">
                                    <img src="{{ asset('client/images/course/author-5.png')}}" alt="eduact">
                ...
                <div class="col-xl-4 col-lg-6 wow fadeInUp" data-wow-delay="600ms">
                    <div class="course-one__item">
                        <div class="course-one__thumb">
                            <img src="{{ asset('client/images/course/course-1-6.png')}}" alt="eduact">
                            <a class="course-one__like" href="javascript:void(0);"><span class="icon-like"></span></a>
                        </div><!-- /.course-thumb -->
                        <div class="course-one__content">
                            ...
                            <div class="course-one__bottom">
                                <div class="course-one__author">
                                    <img src="{{ asset('client/images/course/author-6.png')}}" alt="eduact">
                                    <h5 class="course-one__author__name">Guy Hawkins</h5>
            ...
            <div class="row">
                <div class="col-lg-6 wow fadeInLeft" data-wow-delay="200ms">
                    <div class="counter-one__left">
                        ...
                        <img src="{{ asset('client/images/shapes/counter-dot.png')}}" alt="eduact">
                    </div>
                </div>
                <div class="col-lg-6">
        ...
        <div class="container">
            ...
            "navText": ["<span class=\"icon-arrow-left\"></span>","<span class=\"icon-arrow\"></span>"]
                    ...
                    <div class="item">
                        <div class="testimonial-one__item">
                            <div class="testimonial-one__author">
                                <img src="{{ asset('client/images/resources/testimonial-1-author-1.png')}}" alt="eduact">
                    ...
                    <div class="item">
                        <div class="testimonial-one__item">
                            <div class="testimonial-one__author">
                                <img src="{{ asset('client/images/resources/testimonial-1-author-2.png')}}" alt="eduact">
                            </div><!-- testimonial-author -->
                            <div class="testimonial-one__content">
                                <div class="testimonial-one__quote">
                                    Flexible Classes refers to the process of acquiring knowledge or skills through the use of digital technologies and the internet.
                    ...
                    <div class="item">
                        <div class="testimonial-one__item">
                            <div class="testimonial-one__author">
                                <img src="{{ asset('client/images/resources/testimonial-1-author-3.png')}}" alt="eduact">
                            </div><!-- testimonial-author -->
                            <div class="testimonial-one__content">
                                <div class="testimonial-one__quote">
                                    Flexible Classes refers to the process of acquiring knowledge or skills through the use of digital technologies and the internet.
                ...
                <div class="testimonial-one__thumb wow fadeInUp" data-wow-delay="200ms">
                    <img src="{{ asset('client/images/resources/testimonial-1.png')}}" alt="eduact">
                    ...
                    <div class="testimonial-one__thumb-pen wow fadeInUp" data-wow-delay="400ms">
                        <img src="{{ asset('client/images/shapes/testimonial-shape-1.png')}}" alt="eduact">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                    <div class="team-one__item">
                        <div class="team-one__image">
                            <img src="{{ asset('client/images/team/team-1-1.jpg')}}" alt="eduact">
                        </div><!-- /.team-image -->
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                    <div class="team-one__item">
                        <div class="team-one__image">
                            <img src="{{ asset('client/images/team/team-1-2.jpg')}}" alt="eduact">
                        </div><!-- /.team-image -->
                        <div class="team-one__content">
                            <h3 class="team-one__title">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                    <div class="team-one__item">
                        <div class="team-one__image">
                            <img src="{{ asset('client/images/team/team-1-3.jpg')}}" alt="eduact">
                        </div><!-- /.team-image -->
                        <div class="team-one__content">
                            <h3 class="team-one__title">
                ...
                <div class="col-xl-8 wow fadeInUp" data-wow-delay="200ms">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="blog-one__image">
                                    <img src="{{ asset('client/images/blog/blog-1-1.jpg')}}" alt="eduact">
                                ...
                                <div class="blog-one__content">
                                    ...
                                    <div class="blog-one__meta">
                                        <div class="blog-one__meta__author">
                                            <img src="{{ asset('client/images/blog/author-1.png')}}" alt="eduact" />
                    ...
                    <div class="blog-one__item">
                        <div class="row">
                            <div class="col-md-5">
                                <div class="blog-one__image">
                                    <img src="{{ asset('client/images/blog/blog-1-2.jpg')}}" alt="eduact">
                            ...
                            <div class="col-md-7 d-flex align-items-center">
                                <div class="blog-one__content">
                                    ...
                                    <div class="blog-one__meta">
                                        <div class="blog-one__meta__author">
                                            <img src="{{ asset('client/images/blog/author-2.png')}}" alt="eduact" />
            ...
            <div class="row">
                <div class="col-lg-4 col-md-7 wow fadeInLeft" data-wow-delay="200ms">
                    <div class="cta-one__left">
                        <img src="{{ asset('client/images/shapes/cta-logo.png')}}" alt="eduact" />
                ...
                <div class="col-lg-5 col-md-12">
                    <div class="cta-one__thumb__area wow fadeInUp" data-wow-delay="200ms">
                        <div class="cta-one__thumb eduact-tilt" data-tilt-options='{ "glare": false, "maxGlare": 0, "maxTilt": 4, "speed": 700, "scale": 1 }'>
                            <img src="{{ asset('client/images/resources/cta-1.png')}}" alt="eduact">
                        </div>
