    ...
    <nav class="main-menu">
        <div class="container">
            <div class="main-menu__logo">
                <a href="index.html">
                    <img src="{{ asset('client/images/logo-light.png')}}" width="183" height="48" alt="Eduact">
                </a>
            </div><!-- /.main-menu__logo -->
                                        ...
                                        <div class="home-showcase__inner">
                                            <div class="row">
                                                <div class="col-lg-3">
                                                    <div class="home-showcase__item">
                                                        <div class="home-showcase__image">
                                                            <img src="{{ asset('client/images/home-showcase/home-showcase-1-1.png')}}" alt="eduact">
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="home-showcase__item">
                                                        <div class="home-showcase__image">
                                                            <img src="{{ asset('client/images/home-showcase/home-showcase-1-2.png')}}" alt="eduact">
                                                            <div class="home-showcase__buttons">
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="home-showcase__item">
                                                        <div class="home-showcase__image">
                                                            <img src="{{ asset('client/images/home-showcase/home-showcase-1-3.png')}}" alt="eduact">
                                                            <div class="home-showcase__buttons">
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="home-showcase__item">
                                                        <div class="home-showcase__image">
                                                            <img src="{{ asset('client/images/home-showcase/home-showcase-1-4.png')}}" alt="eduact">
                                                            <div class="home-showcase__buttons">
